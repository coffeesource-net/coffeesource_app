...
PAPAPEPPER_CONTEST_ENTRIES = [
    ...
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 48',
        'permlink': 'the-daily-selfie-challenge-day-48-1175-sbd-prize-pool-and-growing',
        'challenge': 'DAY 48 - JUST HANGING AROUND',
        'description': 'To qualify: <br> 1 - Competitors needed to hang onto something with one hand.<br>2 - Pull their feet off the ground and make sure that they are in the selfie.<br>3 - Took a selfie with your other hand. important! (no timers or help)',
        'prize_pool': 'The current prize pool was 1175 SBD',
    },
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 49',
        'permlink': 'the-daily-selfie-challenge-day-49-1190-sbd-prize-pool-and-growing',
        'challenge': 'DAY 49 - STAND OUT IN A CROWD',
        'description': 'To qualify: <br> 1 - Competitors needed to take a selfie with at least 7 other people in it.<br>2 - The people neededto be real, and actually there with them.<br>3 - Unsuspecting strangers could have worked.',
        'prize_pool': 'The current prize pool was 1190 SBD',
    },
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 50',
        'permlink': 'the-daily-selfie-challenge-day-50-1200-sbd-prize-pool-and-growing',
        'challenge': 'DAY 50 - I SMELL SOMETHING FOWL',
        'description': 'To qualify: <br> 1 - Competitors needed some sort of "bump" on top their heads.<br>2 - Competitors needed a beak over their mouth and nose.<br>3 - Competitors needed to make their faces white. (Not Caucasian skin tone)<br>4 - They needed two dangling red things on each side of their faces.',
        'prize_pool': 'The current prize pool was 1200 SBD',
    },
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 51',
        'permlink': 'the-daily-selfie-challenge-day-51-1212-sbd-prize-pool-and-growing-warning-short-round-tomorrow',
        'challenge': 'DAY 51 - WHICH WAY IS UP?',
        'description': 'To qualify: <br> 1 - Competitors needed themselves + 3 others for this one.<br>2 - Competitors needed to be right-side up.<br>3 - One other person needed to be upsidedown.<br>4 - Two people needed to be sideways.',
        'prize_pool': 'The current prize pool was 1212 SBD',
    },
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 52',
        'permlink': 'the-daily-selfie-challenge-day-52-1221-sbd-prize-pool-and-growing',
        'challenge': 'DAY 52 - ROCK STAR!!',
        'description': 'To qualify: <br> 1 - Competitors needed some sort of a musical instrument.<br>2 - Competitors needed to be shouting (singing like an angry rock star).',
        'prize_pool': 'The current prize pool was 1221 SBD',
    },
    {
        'title': 'THE DAILY STEEMIT SELFIE CHALLENGE - DAY 53',
        'permlink': 'the-daily-selfie-challenge-day-53-1234-sbd-prize-pool-and-growing',
        'challenge': 'DAY 53 - BALANCING ACT',
